    ...
    <div className="flex h-screen w-full bg-gray-50">
      ...
      <div className="flex-grow h-full relative flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between shadow-sm z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-300 text-gray-700 rounded text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              <Palette size={16} /> Theme
            </button>
            <button
              onClick={() => setIsRepoModalOpen(true)}
              className="flex items-center gap-2 px-3 py-1.5 bg-indigo-600 text-white rounded text-sm font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              Load Repo
            </button>
            ...
            <button
              onClick={handleClear}
              className="flex items-center gap-2 px-3 py-1.5 bg-red-50 text-red-600 border border-red-200 rounded text-sm font-medium hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors shadow-sm"
              title="Clear Graph"
            >
              Clear
            </button>
        ...
        <div className="flex-grow relative">
          ...
          {/* Legend */}
          <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm p-3 rounded-lg shadow-md border border-gray-200 z-10 text-xs">
        ...
        <div className="p-4 border-b border-gray-200 bg-indigo-600 text-white">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (e.target.value) {
                setHighlightedDescendants(new Set()); // Update: Clear descendant view when searching
                setShowDescendantList(false);
              }
            }}
            className="w-full px-3 py-2 rounded text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1 font-mono text-sm bg-gray-100 p-2 rounded break-all">
                        ...
                        <div className="max-h-60 overflow-y-auto border-t border-gray-200 p-1">
                          {Array.from(highlightedDescendants).sort().map(childName => (
                            <button
                              ...
                              className="w-full text-left px-3 py-1.5 text-xs text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded transition-colors truncate"
                              title={childName}
                            >
                              {childName}
                            </button>
                ...
                {['pre-run', 'post-run', 'run'].map(key => {
                  ...
                  return (
                    <div key={key}>
                      ...
                      <div className="mt-1 bg-gray-50 p-2 rounded border border-gray-100 font-mono text-sm">
                        ...
                        <div key={idx} className="border-l-2 border-orange-200 pl-3">
                          <div className="text-xs text-orange-600 font-medium mb-2 flex items-center gap-1">
                            ...
                            <button
                              ...
                              className="font-mono bg-orange-50 px-1 rounded hover:underline hover:text-orange-800 cursor-pointer border border-transparent hover:border-orange-200 transition-colors"
              ...
              {nodes.length === 0 ? (
                ...
                nodes.map(node => (
                  <div
                    ...
                    className="p-3 border border-gray-200 rounded hover:bg-indigo-50 cursor-pointer transition-colors"
                  >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
              ...
              {chatHistory.map((msg, idx) => (
                <div key={idx} className={`flex ${msg.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[85%] rounded-lg p-3 text-sm ${msg.type === 'user' ? 'bg-indigo-600 text-white' : 'bg-white border border-gray-200 shadow-sm'}`}>
                    {msg.text}
                  </div>
                </div>
              ))}
            ...
            <form onSubmit={handleChatSubmit} className="p-4 border-t border-gray-200 bg-white flex gap-2 rounded-b-lg">
              <input
                ...
                className="flex-1 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:bg-gray-100"
              />
              <button
                type="submit"
            ...
            <form onSubmit={handleLoadRepo} className="p-4">
              ...
              {activeRepos.length > 0 && (
                <div className="mb-4">
                  ...
                  <div className="max-h-[100px] overflow-y-auto border border-gray-200 rounded bg-indigo-50 p-2">
              ...
              {repoHistory.length > 0 && (
                <div className="mb-4">
                  ...
                  <div className="max-h-[150px] overflow-y-auto border border-gray-200 rounded bg-gray-50">
        ...
        >
          ...
          >
                  ...
                  <div key={type.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 flex justify-center">
                        <div
                          className="px-4 py-2 rounded text-sm font-medium shadow-sm transition-all"
                          style={{
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-lg flex justify-between items-center">
              <button
                onClick={resetColors}
                className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 hover:bg-red-50 px-3 py-1.5 rounded transition-colors"
              >
